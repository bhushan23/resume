...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
         \resumeItem{Thesis} {Face editing using GANs; \textbf{Advisor}: Prof. Dimitris Samaras; Computer Vision Lab}
...
\section{Select Projects}
  \resumeSubHeadingListStart
    ...
    {Applying GANs for facial geometry construction and editing facial attributes. [Python, PyTorch]}
    \resumeSubItem{Object Recognition using Convolution Neural Networks}
    {Implementing ResNet and Wide-Residual Network for object recognition on CIFAR-10 dataset. [Python, PyTorch]}
    ...
    \resumeItem{VIT-OS}
    {Undergraduate course project; Implemented Operating System under hardware simulator- interrupt, timer, channels, reader, printer, auxiliary storage, user storage, multiprogramming and slave mode paging system. [Java, C]}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Technologies}{: PyTorch, Tensorflow, Scikit-learn, Keras, OpenCV, LLVM, Django, Grails, Android.}
    }
  \resumeSubHeadingListEnd
%
%--------AWARDS------------
